...
# Yeni train_model'dan SADECE SectorStandardScaler geliyor
...
def main():
    ...
    for dt in dates:
        ...
        # normalize etmiyoruz → kalan pay nakitte
        ...
        if MARKET_RET_COL in day.columns:
            day_mkt_ret = day[MARKET_RET_COL].mean()
        else:
            day_mkt_ret = 0.0  # kolon yoksa sıfır kabul
